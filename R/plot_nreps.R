...
#'
#' @param object list object of class _nreps_ (generated by [calc_nreps()])
                       ...
                       show.text = TRUE)
{
  ...
  mp <- ggplot2::ggplot(df, ggplot2::aes(x = pair,
                                         y = Phi,
                                         ymin = Phi - SE,
                                         ymax = Phi + SE)) +
    ...
    ggplot2::geom_abline(slope = 0, intercept = 0,
                         ...
                         alpha = .5)
  if (show.CI){
    mp <- mp + ggplot2::geom_errorbar(ggplot2::aes(ymin = Phi - CIHW,
                                                   ymax = Phi + CIHW),
                                      alpha = .5, col = 2,
                                      width = .12, size = 1.2)
  }
  ...
  if (show.SE){
    mp <- mp + ggplot2::geom_linerange(size = 1.8)
  }
